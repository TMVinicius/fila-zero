...
public class TelaInicialLogin extends JFrame {
    ...
    public TelaInicialLogin() {
        ...
        btnCliente.addActionListener(e -> {
            int resposta = JOptionPane.showConfirmDialog(null, "Já possui cadastro?", "Login Cliente", JOptionPane.YES_NO_OPTION);
        ...
        btnAdministrador.addActionListener(e -> {
            new TelaLogin(new model.Usuario()).setVisible(true); // ou sua lógica de admin
            dispose();
        });
    }
}
